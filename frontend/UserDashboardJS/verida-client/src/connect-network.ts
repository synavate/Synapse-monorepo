import React, { useEffect, useState, hasSession } from 'react';
import { useEffect } from 'react-dom;'
import { hasSession } from '@verida/account-web-vault' 
import { walletAddress, setWalletAddress, message, setMessage, login } from '@verida/client-ts'



export const veridaLogin = () => {
