...
class NLP_PARSE:
    '''
    Original KGCreator functionality 
    Class uses Spacy and pre-defined schemas to find the entities in the text
    ...
    def find_entities_in_text(some_text):
        ...
        entities = map(list, [[clean(entity.text), entity.label_] for entity in doc.ents])
        return entities
